...
export const api={ users:()=>request('/users'), generateUsers:()=>request('/users/generate',{method:'POST'}), selectUser:(id)=>request('/auth/select-user',{method:'POST',body:JSON.stringify({id})}), me:()=>request('/auth/me'), topics:()=>request('/topics'), };
